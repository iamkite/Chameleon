...
public class NY_EraseL : MonoBehaviour
{
    ...
    void Start()
    {
        hand = GameManager.Instance.LHand;
    ...
    private void SelectErase()
    {
        if (OVRInput.Get(OVRInput.Button.PrimaryIndexTrigger, OVRInput.Controller.LTouch))
        {
            ...
            lr.enabled = true;
            lr.SetPosition(0, GameManager.Instance.LCon.TransformPoint(GameManager.Instance.LlrStart));
            lr.SetPosition(1, hand.transform.position + hand.transform.forward * 3);
    ...
    {
        //지우기
        if (output.transform.childCount != 0 && eraseAll.activeInHierarchy == false && OVRInput.GetDown(OVRInput.Button.PrimaryIndexTrigger, OVRInput.Controller.LTouch))
        {
        ...
        else if (output.transform.childCount == 0 && nothingToErase.activeInHierarchy == false && OVRInput.GetDown(OVRInput.Button.PrimaryIndexTrigger, OVRInput.Controller.LTouch))
        {
            //지울게 없어요! 안내창
