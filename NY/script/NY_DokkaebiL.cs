...
public class NY_DokkaebiL : MonoBehaviour
{
    ...
    public static NY_DokkaebiL Instance;
    private void Awake()
    {
        if (Instance == null)
        {
    ...
    void Update()
    {
        ...
        //도형 잇기
        else if (curCube != null && OVRInput.Get(OVRInput.Button.PrimaryIndexTrigger, OVRInput.Controller.LTouch) && Vector3.Distance(curHandPos, hand.transform.position) > createDistance)
        {
            audios[0].Play();
